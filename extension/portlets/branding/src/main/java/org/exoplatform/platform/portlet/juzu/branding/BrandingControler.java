...
public class BrandingControler {
  ...
  public Response.Content getStyleValue() {
    String style = (String) settingService.get(Context.GLOBAL,
                                               Scope.GLOBAL,
                                               BAR_NAVIGATION_STYLE_KEY).getValue();
    if (style == null || this.style == "") {
      style = "dark";
    }
  ...
  @Resource
  @Route("/resource")
  public Response.Content save(String style, FileItem file) throws IOException {
    if (style != null && style != "") {
