...
@Assets(scripts = {
    ...
    @Script(id = "jsForm", src = "js/common/jquery.form.js", depends = "jquery", location = juzu.asset.AssetLocation.SERVER),
    @Script(src = "branding.js", depends = { "jsForm", "firedrop", "imgscale" }, location = AssetLocation.CLASSPATH) }, stylesheets = { @Stylesheet(src = "style/branding.css", location = AssetLocation.CLASSPATH) })
