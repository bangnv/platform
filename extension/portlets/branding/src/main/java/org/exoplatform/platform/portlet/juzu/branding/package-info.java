...
@Assets(scripts = {
    ...
    @Script(src = "branding.js", depends = { "form", "imgscale" }, location = AssetLocation.CLASSPATH) }, stylesheets = { @Stylesheet(src = "style/branding.css", location = AssetLocation.CLASSPATH) })
